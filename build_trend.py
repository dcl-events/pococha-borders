...
<div class="app">
  ...
  <div class="card">
    ...
    <div class="chartwrap">
      <svg class="chart" id="chart" viewBox="0 0 720 210" preserveAspectRatio="none" role="img"
...
function drawChart(pts, med){
  ...
  chartState = { pts: pts.map((p,i)=>({ x:x(i), y:y(p.v), iso:p.iso, d:p.d, v:p.v })) };
}
