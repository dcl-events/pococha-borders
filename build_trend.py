...
<style>
  :root{ --bg:#f6f7f9; --card:#fff; --border:#e3e8ef; --text:#1a1d21; --sub:#697586;
         --accent:#5b8def; --accent-soft:#c9dcff; --accent-bg:#eaf1ff; --track:#f3f5f8; --hot:#e8544f; }
  @media (prefers-color-scheme:dark){
    :root{ --bg:#0f1216; --card:#161b22; --border:#2a313c; --text:#e6edf3; --sub:#9aa4b2;
           --accent:#5b8def; --accent-soft:#2a3d5f; --accent-bg:#1b2740; --track:#1c232c; }
  }
  *{ box-sizing:border-box; }
  ...
  .backlink{ margin-left:auto; text-decoration:none; font-size:13px; font-weight:700;
             padding:7px 14px; border-radius:999px; border:1px solid var(--accent); color:var(--accent);
             display:inline-flex; align-items:center; gap:3px; }
  .backlink:hover{ background:var(--accent-bg); }
  ...
  .daydot{ fill:var(--accent); opacity:.30; }
  #guide{ stroke:var(--accent); stroke-width:1; opacity:0; pointer-events:none; }
  #hoverdot{ fill:var(--accent); stroke:var(--card); stroke-width:2; opacity:0; pointer-events:none; }
  .tip{ position:absolute; top:4px; transform:translateX(-50%); pointer-events:none; opacity:0;
        transition:opacity .08s; background:var(--card); border:1px solid var(--border); border-radius:10px;
        padding:5px 10px; box-shadow:0 4px 14px rgba(0,0,0,.14); white-space:nowrap; text-align:center; }
  .tip .tipd{ display:block; font-size:11px; color:var(--sub); }
  .tip .tipv{ display:block; font-size:14px; font-weight:800; color:var(--accent); }
  .tip .tipbtn{ display:block; margin-top:6px; pointer-events:auto; cursor:pointer; border:none;
    border-radius:8px; background:var(--accent); color:#fff; font-size:11px; font-weight:700;
    padding:5px 12px; white-space:nowrap; width:100%; }
  .tip .tipbtn:active{ opacity:.85; }
  .charthint{ font-size:11px; color:var(--sub); text-align:center; margin-top:10px; }
...
<div class="app">
  ...
  <div class="card">
    ...
    <div class="charthint">日付をなぞって数値を確認 ／「早見表で見る →」でその日の早見表へ</div>
  </div>
